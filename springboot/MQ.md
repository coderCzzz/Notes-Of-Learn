...
5. JMS与AMQP对比
   ...
   ![1554615579819](E:\Typora Data\Notes-Of-Learn\Images\1554615579819.png)
...
![1554539106949](E:\Typora Data\Notes-Of-Learn\Images\1554539106949.png)

- 如图，场景是我们做一个注册的功能，之前我们所作的流程是这样的：用户去注册，我们将注册信息写入数据库，然后再分别去发送注册邮件和注册短信，这样整个流程下来，所需的是150ms。可以改进如下：

  ![1554539247119](E:\Typora Data\Notes-Of-Learn\Images\1554539247119.png)

- 在注册完之后，我们使用多线程，将发送注册邮件和发送注册作为两个线程，并 步执行，这样相应时间就缩短为了100ms，那么还能继续改进嘛？

![1554539458895](E:\Typora Data\Notes-Of-Learn\Images\1554539458895.png)

- 如图：我们可以使用消息队列，将这些信息写进消息队列，写进之后，立马返回给用户，后面发送邮件可以慢慢执行。让发送注册邮件和发送注册短信去自己读取消息队列中的信息，这样响应时间就变为了55ms

### 1.2.2应用解耦

![1554539761407](E:\Typora Data\Notes-Of-Learn\Images\1554539761407.png)
...
![1554539802357](E:\Typora Data\Notes-Of-Learn\Images\1554539802357.png)
...
10. Broker
    ...
    ![1554617772748](E:\Typora Data\Notes-Of-Learn\Images\1554617772748.png)
...
![1554618208703](E:\Typora Data\Notes-Of-Learn\Images\1554618208703.png)
...
- direct：
  ...
  ![1554618610671](E:\Typora Data\Notes-Of-Learn\Images\1554618610671.png)

- fanout

   ![1554618728282](E:\Typora Data\Notes-Of-Learn\Images\1554618728282.png)

- topic

  ![1554618788613](E:\Typora Data\Notes-Of-Learn\Images\1554618788613.png)
